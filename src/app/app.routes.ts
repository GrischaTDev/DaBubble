...
export const routes: Routes = [
    ...
    { path: 'thread', component: DesktopThreadComponent, canActivate: [authGuard] },
    { path: 'user-profile', component: UserProfileComponent, canActivate: [authGuard] },
    { path: 'chat/:id', component: MobileChatComponent, canActivate: [authGuard] },
    { path: 'direct-chat/:userId', component: DirectChatComponent, canActivate: [authGuard] },
];
